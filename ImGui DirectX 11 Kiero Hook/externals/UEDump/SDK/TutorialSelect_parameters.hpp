...
public:
	...
	uint8                                         Pad_1675[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1676[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_3;            // 0x005C(0x0010)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_1677[0x4];                                     // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
